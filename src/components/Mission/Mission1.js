        ...
        <div className='mission1'>
                <div className='mission1-content'>
                        <div className='mission1-header'>
                            <h1>Our Mission</h1>
                            <h2>To provide the best quality transitional housing and treatment for those seeking recovery that creates long-lasting, positive change in your life and the world around you.</h2>
                        </div>
